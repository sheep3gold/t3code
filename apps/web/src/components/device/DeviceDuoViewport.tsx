...
export function DeviceDuoViewport(props: {
  ...
  }, [onInputCancel, onResetReady, client, onUnavailable, source, onFramingAspect]);
  ...
  return (
    <div className="absolute inset-0">
      ...
      >
        ...
        <canvas
          ref={canvasRef}
          aria-label="Interactive 3D iPhone Duo. Drag the screen to interact. Drag outside it or swipe with two fingers to turn. Pinch to zoom."
